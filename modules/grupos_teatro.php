...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo->set("label","Inscrito al 2º Encuentro <br>Iberoamericano <br>de Circo");
  ...
  $atributo->set("mandatory",TRUE);
    ...
    $atributo=new attribute($entidad);
	$atributo->set("field","otro");
	$atributo->set("label","Otro:");
	$atributo->set("sqlType","character varying(255)");
	$atributo->set("mandatory",FALSE);
	$atributo->set("editable",TRUE);
	$atributo->set("searchable",TRUE);
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","tipo_circo");
	$atributo->set("label","Si usted representa o hace parte de un circo especifique si es:");
	$atributo->set("sqlType","character varying(255)");
	$atributo->set("mandatory",FALSE);
	$atributo->set("editable",TRUE);
	$atributo->set("searchable",TRUE);
