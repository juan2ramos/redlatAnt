<?
	...
	$entidad->set("labelModule","Promotores - Tareas");
...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","id_tarea");
	$atributo->set("label","Tarea");
	$atributo->set("inputType","select");
	$atributo->set("foreignTable","pr_tareas");
	$atributo->set("foreignModule","pr_tareas");
