<?
	...
	$entidad->set("name","artistas_teatro");
	$entidad->set("labelModule","Actores");
	$entidad->set("table","artistas_teatro");
...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo->set("sqlType","smallint(6)");
	$atributo->set("arrayValues",array("1"=>"Director","2"=>"Actor/Actriz","3"=>"Técnico","4"=>"Productor","5"=>"Músico","6"=>"Bailarín/a","7"=>"Titiritero/a"));
	$atributo->set("mandatory",TRUE);
	$atributo->set("searchable",TRUE);
	$atributo->set("browseable",TRUE);
	$atributo->set("shortList",TRUE);
