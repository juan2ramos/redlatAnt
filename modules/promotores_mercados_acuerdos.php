<?
	...
	$entidad->set("labelModule","Promotores - Mercados - Acuerdos");
...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","id_tipo_acuerdo");
	$atributo->set("label","Tipo de acuerdo");
	$atributo->set("inputType","select");
	$atributo->set("foreignTable","tipos_acuerdo");
