...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","consideracion_contrato");
	$atributo->set("label","¿Consideraría contratar a este grupo?");
	$atributo->set("sqlType","tinyint(4)");
	$atributo->set("defaultValue","1");
	$atributo->set("inputType","option");
	$atributo->set("mandatory",TRUE);
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","porque");
	$atributo->set("label","¿Porqué?");
	...
	$atributo->set("label","¿Le gustaría recibir información via e-mail de este grupo?");
	$atributo->set("sqlType","tinyint(4)");
	$atributo->set("defaultValue","1");
	$atributo->set("inputType","option");
	$atributo->set("mandatory",TRUE);
