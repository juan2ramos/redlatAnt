<?
	...
	$entidad->set("name","artistas_danza");
	$entidad->set("labelModule","Actores");
	$entidad->set("table","artistas_danza");
...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo->set("ACLimit","15");
	$atributo->set("ACIdField","artistas.id");
	$atributo->set("ACLabel","concat(artistas.nombres, ' ', artistas.apellidos, ' (',artistas.pasaporte,')') ");
	$atributo->set("ACFields","artistas.nombres,artistas.apellidos,artistas.pasaporte");
	if($_SESSION[$CFG->sesion_admin]["user"]["id_nivel"] == 7)
	{
	...
	$atributo->set("sqlType","smallint(6)");
	$atributo->set("arrayValues",array("1"=>"Director","2"=>"Bailarín","3"=>"Técnico","4"=>"Actor/actriz","5"=>"Músico"));
	$atributo->set("mandatory",TRUE);
	$atributo->set("searchable",TRUE);
	$atributo->set("browseable",TRUE);
	$atributo->set("shortList",TRUE);
