<?
	...
	class grupos_musica extends entity
	{
		...
		function update()
		{
			...
			if($datos_grupo['ingresado_por']==0){ 
			  /* $this->db->sql_query("UPDATE " . $this->table . " SET ingresado_por=1 WHERE id =".$this->id."");*/
			   
			  /* $strMail="NOTIFICACIÓN - INSCRIPCIÓN CIRCULART 2012\n\n";
			   $strMail.="Usted ha quedado INSCRITO OFICIALMENTE en la Convocatoria de CIRCULART 2012.\n\n";
			   $strMail.="Recuerde subir toda la información que se le solicita.\n\n";
			   $strMail.="Atentamente,\n\n";
			  ...
			  mail($datos_grupo['email'],"Notificación Inscripción CIRCULART 2012",$strMail,"From: linfo@circulart.org");
			
				$strMail2="NOTIFICACIÓN - INSCRIPCIÓN CIRCULART 2012\n\n";
				$strMail2.="El grupo o el artista: ".$datos_grupo['nombre']." acaba de INSCRIBIRSE OFICIALMENTE en la Convocatoria CIRCULART 2012.\n\n";
			  ...
			  mail("notificacionescirculart@gmail.com","Notificación Inscripción CIRCULART 2012",$strMail2,"From: info@circulart.org");
			  mail("ncirculart@gmail.com","Notificación Inscripción CIRCULART 2012",$strMail2,"From: info@redlat.com");*/
			  
			}else if($datos_grupo['ingresado_por']==1){
				
				/**/
				/*$strMail="NOTIFICACIÓN - ACTUALIZACIÓN INSCRIPCIÓN CIRCULART 2012\n\n";
				$strMail.="Usted ha actualizado la INSCRIPCIÓN a la Convocatoria CIRCULART 2012.\n\n";
				$strMail.="Recuerde subir toda la información que se le solicita.\n\n";
				$strMail.="Atentamente,\n\n";
				$strMail.="CIRCULART - REDLAT\n";
				$strMail.="info@circulart.org\n";
			...
			mail($datos_grupo['email'],"Notificación Actualización Inscripción Circulart 2012",$strMail,"From: info@circulart.org");
			
				$strMail2="NOTIFICACIÓN - ACTUALIZACIÓN INSCRIPCIÓN CIRCULART 2012\n\n";
				$strMail2.="El grupo o el artista: ".$datos_grupo['nombre']." acaba de ACTUALIZAR la INSCRIPCIÓN a la Convocatoria Circulart 2012.\n\n";
				$strMail2.="Atentamente,\n\n";
				$strMail2.="CIRCULART - REDLAT\n";
				$strMail2.="info@circulart.org\n";
				$strMail2.="http://circulart.org/circulart2012/\n";
			...
			mail("notificacionescirculart@gmail.com","Notificación Actualización Inscripción Circulart 2012",$strMail2,"From: info@circulart.org");
			mail("ncirculart@gmail.com","Notificación Actualización Inscripción Circulart 2012",$strMail2,"From: info@redlat.com");*/
...
//	$atributo->set("subQuery","id");
	...
	$atributo->set("label","Acepto los términos y <br>condiciones de la convocatoria como las condiciones de manejo de datos.");
	...
	$atributo->set("label","Inscripción");
  ...
  $atributo->set("mandatory",TRUE);
	...
	$atributo->set("label","Publicar en <br>la página Circulart.org");
	$atributo->set("inputType","option");
	$atributo->set("sqlType","boolean");
	$atributo->set("defaultValue","f");
	$atributo->set("mandatory",TRUE);
	...
	/*$entidad->addAttribute($atributo);
	$atributo=new attribute($entidad);
	$atributo->set("field","show");
	$atributo->set("label","show");
	$atributo->set("sqlType","tinyint(4)");
	$atributo->set("defaultValue","0");
	$atributo->set("defaultValueSQL","0");
	$atributo->set("inputType","option");
