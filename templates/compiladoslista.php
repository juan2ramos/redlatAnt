...
GLOBAL $CFG, $db, $ME;
	...
	include($CFG->templatedir . "/header.php");
	$qReportes=$db->sql_query("SELECT * FROM compilados ORDER BY id");
	$qReportes2=$db->sql_query("SELECT * FROM compiladostracklist");
	include($CFG->templatedir . "/compilado_listado.php");
}
