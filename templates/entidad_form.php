...
//		print_r($base);
		...
		echo "<tr bgcolor='#ffffff'><td align='right' bgcolor='#ffffff' nowrap>".$titulo." : </td>
		...
		elseif($base["tipo"] == 2)
		{
			...
			<object type="application/x-shockwave-flash" data="http://circulart.org/audio_base/player.swf" id="audioplayer<?=$entidad->id?>" height="24" width="290">
			<param name="movie" value="http://circulart.org/audio_base/player.swf">
			<param name="FlashVars" value="playerID=<?=$entidad->id?>&amp;soundFile=http://circulart.org<?=$carpeta?>">
